...
@section('title', 'Tambah Produk - ' . $mitra->name)
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Mitra POS / {{ $mitra->name }} / Produk /</span> Tambah Baru
    </h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('mitra-product.store', $mitra) }}" method="POST" id="productForm">
                    @csrf
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label class="form-label">SKU <span class="text-danger">*</span></label>
                                <input type="text" name="sku" class="form-control" value="{{ old('sku') }}" placeholder="Contoh: SLK011" required>
                            </div>
                            <div class="col-md-5">
                                <label class="form-label">Nama Produk <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: Kopi Susu Bapak Dingin" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Varian</label>
                                <input type="text" name="variant" class="form-control" value="{{ old('variant') }}" placeholder="Contoh: Dingin">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="category" class="form-control" value="{{ old('category') }}" placeholder="Contoh: Kopi Susu">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.0001" min="0" name="q_factor" id="q_factor" class="form-control" value="{{ old('q_factor', '0.2') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" inputmode="numeric" name="sale_price" id="sale_price" class="form-control rupiah-input" value="{{ old('sale_price') }}" placeholder="Contoh: 22.000" required>
                            </div>
                        </div>
