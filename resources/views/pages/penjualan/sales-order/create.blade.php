...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Penjualan / Sales Order /</span> Buat Baru
    </h4>
            ...
            <div class="card">
                <form action="{{ route('sales-order.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input" type="radio" name="customer_type" id="type_mitra" value="mitra" checked>
                                    <label class="form-check-label" for="type_mitra">Pilih dari Mitra</label>
                                </div>
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input" type="radio" name="customer_type" id="type_manual" value="manual">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12" id="mitra_container">
                                <label class="form-label">Nama Mitra</label>
                                <select name="mitra_id" class="form-select select2" id="mitra_select">
                                    <option value="">-- Pilih Mitra --</option>
                                    @foreach($mitras as $mitra)
                                        <option value="{{ $mitra->id }}">{{ $mitra->code }} - {{ $mitra->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-12 d-none" id="manual_container">
                                <label class="form-label">Nama Customer</label>
                                <input type="text" name="customer_name" id="manual_input" class="form-control" placeholder="Contoh: Budi Susanto">
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Fallback jika $ tidak ada (kadang jQuery butuh waktu untuk load karena defer)
